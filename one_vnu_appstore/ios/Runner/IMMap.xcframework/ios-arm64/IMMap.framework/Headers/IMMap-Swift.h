...
@class NSProgress;
@interface NSFileManager (SWIFT_EXTENSION(IMMap))
...
@property (nonatomic, weak) id <IMMapViewControllerDelegate> _Nullable delegate;
...
- (void)mapViewControllerShouldCloseWithVc:(IMMapViewController * _Nonnull)vc;
@end

SWIFT_CLASS("_TtC5IMMap14IMMapViewModel")
@interface IMMapViewModel : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) IMMapViewModel * _Nonnull shared;)
+ (IMMapViewModel * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)setLanguageCode:(NSString * _Nonnull)code;
- (void)deeplinkDirectionToPOI:(NSString * _Nonnull)poiID fromPOIID:(NSString * _Nonnull)fromPOIID onVenue:(NSString * _Nonnull)venueID floorID:(NSString * _Nonnull)floorID;
- (void)deeplinkOpenWithVenue:(NSString * _Nonnull)venueID floorID:(NSString * _Nonnull)floorID;
- (void)deeplinkLocateWithPoi:(NSString * _Nonnull)poiID venueID:(NSString * _Nonnull)venueID floorID:(NSString * _Nonnull)floorID;
- (void)changeVenueWithVenueID:(int32_t)_venueId;
- (void)directionFrom:(NSString * _Nullable)poiId to:(NSString * _Nullable)toPoiId;
- (void)locateWithPoi:(NSString * _Nonnull)poiId;
- (void)reset;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
