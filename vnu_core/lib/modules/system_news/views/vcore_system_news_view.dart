...
import 'vcore_system_news_filter_widget.dart';
import 'vcore_system_news_item_widget.dart';

class VcoreSystemNewsView extends GetView<VcoreSystemNewsController> {
  const VcoreSystemNewsView({super.key});
                                    ...
                                    action: () {
                                      ...
                                      Get.dialog(Dialog(
                                        ...
                                        child: Padding(
                                          ...
                                          child: VcoreSystemNewsFilterWidget(
                                       ...
                                       onTap: () {
                                         ...
                                         Get.to(
                                           () => VcoreNotifyDetailViewV3(
                                             title: tinTucModel.tieuDe ?? 'Thông báo',
                                             htmlContent: tinTucModel.noiDung ?? '',
                                             sender: tinTucModel.nguonTin,
                                             date: tinTucModel.thoiGian,
                                             category: 'Tin hệ thống',
                                             fileGuids: tinTucModel.guidFileDinhKems,
                                             fileNames: tinTucModel.tenFileDinhKems,
                                             showMetadata: true,
                                           ),
                                         );
                                       },
                                      child: VcoreSystemNewsItemWidget(
