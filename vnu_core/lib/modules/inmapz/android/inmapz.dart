...
class IMMapViewController {
  ...
  final MethodChannel _channel =
      const MethodChannel('plugins.where.place/flutter_to_android');
  static const MethodChannel _channel2 =
      const MethodChannel('plugins.where.place/android_to_flutter');
  ...
  Future<void> searchRouteByRef(
      {required IMSearchRouteByRefInput searchRouteByRefInput}) {
  ...
  Future<void> locatePOIByRef(
      {required IMLocatePOIByRefInput locatePOIByRefInput}) {
    final Map<String, String> args = <String, String>{
  ...
  Future<String?> getListDataByCategory(
      {required IMCategoryFloorInput categoryFloorInput}) {
    final Map<String, int> args = <String, int>{
  ...
  Future<String?> getListDataByRegion(
      {required IMRegionFloorInput regionFloorInput}) {
    final Map<String, int> args = <String, int>{
  ...
  Future<String?> getListDataByType(
      {required IMTypeFloorInput typeFloorInput}) {
    final Map<String, int> args = <String, int>{
  ...
  Future<bool> focusPoiByType(
      {required IMTypeFocusInput typeFocusInput}) async {
    final Map<String, int> args = <String, int>{
  ...
  Future<bool> focusPoiByCategory(
      {required IMCategoryFocusInput categoryFocusInput}) async {
    final Map<String, int> args = <String, int>{
  ...
  Future<bool> focusPoiByRegion(
      {required IMRegionFocusInput regionFocusInput}) async {
    final Map<String, int> args = <String, int>{
...
class IMMapViewAndroid extends StatefulWidget {
  const IMMapViewAndroid({
    super.key,
    this.language = 'vi',
    this.kioskRef = '',
  });
  ...
  State<StatefulWidget> createState() {
    ...
    return IMMapViewAndroidState(language: language, kioskRef: kioskRef);
  }
}

class IMMapViewAndroidState extends State<IMMapViewAndroid>
    implements AppCaller {
  final String language;
  final String kioskRef;
  IMMapViewAndroidState({this.language = 'vi', this.kioskRef = ''}) : super();
