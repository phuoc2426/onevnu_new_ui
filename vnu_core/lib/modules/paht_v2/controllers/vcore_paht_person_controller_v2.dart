...
class VcorePahtPersonControllerV2 extends GetxController {
  ...
  VcorePahtPersonControllerV2(this.trangThaiXuLy);
  ...
  Future<void> _loadData() async {
    try {
      ...
      final ApiResponse<List<PhanAnhHienTruongModel>> response = await ApiRepository().getPahtCaNhan(
