...
mixin _$ApiResponse<T> {
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(statusCode: $statusCode, pageIndex: $pageIndex, totalCount: $totalCount, totalPage: $totalPage, message: $message, data: $data)';
  }
}
...
extension ApiResponsePatterns<T> on ApiResponse<T> {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String statusCode, int? pageIndex, int? totalCount,
            int? totalPage, String? message, T? data)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ApiResponse() when $default != null:
        return $default(_that.statusCode, _that.pageIndex, _that.totalCount,
            _that.totalPage, _that.message, _that.data);
      case _:
        return orElse();
    }
  }
