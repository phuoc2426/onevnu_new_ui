...
class VcoreAdmissionView extends StatefulWidget {
  ...
  @override
  State<VcoreAdmissionView> createState() =>
      _VcoreAdmissionViewState();
}
...
class _VcoreAdmissionViewState extends State<VcoreAdmissionView> {
  ...
  Future<void> _loadTinTucVNU() async {
    try {
      final List<_CmsVnuItem> data =
      await _getCmsPublicItems(
        _tinTucPath,
        ...
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: <Widget>[
              ...
              SliverToBoxAdapter(
                child: _buildAdmissionUnits(),
              ),
              SliverToBoxAdapter(
                child: _buildUtilities(),
              ),
              SliverToBoxAdapter(
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage(
            'assets/images/admission_bg.png',
          ),
          fit: BoxFit.cover,
  ...
  Widget _buildUtilities() {
    final List<_UtilityItem> utilities =
    <_UtilityItem>[
      _UtilityItem(
        ...
        image:
        'assets/images/state_0_manual.png',
        onTap: () {
          Get.to(
                () => const VcoreCamNangView(),
          );
        },
        showBook: true,
      ),
      _UtilityItem(
        ...
        image:
        'assets/images/state_0_news.png',
        onTap: () {
          _openWebUrl(
            'Tin tức VNU',
            _allNewsUrl,
      ...
      _UtilityItem(
        ...
        'Tìm kiếm nhà trọ '
            'an toàn, tiện lợi',
        image:
        'assets/images/state_0_dormitory.png',
  ...
  static final List<_AdmissionUnit>
  _admissionUnits = <_AdmissionUnit>[
    const _AdmissionUnit(
      ...
      url:
      'https://tuyensinh.hus.vnu.edu.vn/',
      logoUrl:
    ...
    const _AdmissionUnit(
      ...
      url:
      'https://ulis.vnu.edu.vn/tuyensinh2026/',
      logoUrl:
    ...
    const _AdmissionUnit(
      ...
      url:
      'https://ueb.vnu.edu.vn/Tuyen-Sinh',
      logoUrl:
    ...
    const _AdmissionUnit(
      ...
      url:
      'https://vju.ac.vn/tuyensinhdaihoc/thong-tin-tuyen-sinh-2026/',
      logoUrl:
    ...
    const _AdmissionUnit(
      ...
      url:
      'https://ump.vnu.edu.vn/index.html',
      logoUrl:
    ...
    const _AdmissionUnit(
      ...
      'Trường Đại học Luật',
      url:
      'https://law.vnu.edu.vn/tuyen-sinh/',
      logoUrl:
    ...
    const _AdmissionUnit(
      ...
      url:
      'https://www.hsb.edu.vn/admissions',
      logoUrl:
...
class _LoadingHorizontalSection
...
class _CmsVnuItem {
  ...
  factory _CmsVnuItem.fromJson(
      Map<String, dynamic> json,
      ) {
    return _CmsVnuItem(
      id: _readString(json, 'id'),
      anhDaiDien:
      _readString(json, 'anhDaiDien'),
      tieuDe: _readString(json, 'tieuDe'),
      tomTat: _readString(json, 'tomTat'),
      redirectUrl:
      _readString(json, 'redirectUrl'),
      ngayDang:
      _readString(json, 'ngayDang'),
      canonical:
      _readString(json, 'canonical'),
      externalLink:
      _readString(json, 'externalLink'),
      memberName:
      _readString(json, 'memberName'),
      memberDomain:
      _readString(json, 'memberDomain'),
      memberThumbnail:
      _readString(
        json,
        'memberThumbnail',
