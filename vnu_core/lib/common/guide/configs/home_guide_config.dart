...
import '../../../modules/profile/views/vcore_profile_person_info_view.dart';
...
class HomeGuideConfig implements AppGuideModuleConfig {
  ...
  List<AppGuideGroup> get groups => [
    ...
    AppGuideGroup(
      ...
      targetIds: ['home.notice.header', 'home.notice.list'],
    ),
    AppGuideGroup(
      id: 'home.news.group',
      moduleId: AppGuideModuleIds.home,
      ...
      targetIds: ['home.news.header', 'home.news.tabs', 'home.news.carousel'],
    ),
  ];
  ...
  static final List<AppGuideItem> _homeItems = [
    ...
    _homeWidget(
      ...
      keywords: ['tìm kiếm', 'tìm nhanh', 'search', 'hướng dẫn', 'chức năng'],
    ...
    _homeWidget(
      ...
      keywords: ['thông báo', 'notification', 'tin mới', 'đào tạo'],
      fallbackId: 'home.header',
      priority: 900,
      openAction: () async {
    ...
    _homeSection(
      ...
      keywords: ['lịch học', 'lịch thi', 'thời khóa biểu', 'ca thi', 'môn học'],
      priority: 880,
    ),
    _homeSection(
      ...
      keywords: ['truy cập nhanh', 'chức năng', 'ghim', 'mở nhanh', 'tiện ích'],
      priority: 870,
    ),
    _homeSection(
      id: 'home.notice',
      ...
      description:
          'Theo dõi các thông báo đào tạo quan trọng ngay trên trang chủ.',
      icon: Icons.campaign_rounded,
      keywords: ['thông báo quan trọng', 'thông báo đào tạo', 'tin đào tạo'],
      priority: 860,
    ),
    _homeSection(
      id: 'home.news',
      ...
      keywords: ['tin tức', 'tin trường', 'tin vnu', 'bài viết'],
      priority: 850,
    ),
  ];
  ...
  static final List<AppGuideItem> _homeOverviewItems = [
    _homeWidget(
      ...
      keywords: ['tiết học', 'hôm nay', 'lịch học hôm nay'],
    ...
    _homeWidget(
      ...
      keywords: ['lịch thi', 'sắp tới', 'thi', 'ca thi'],
      fallbackId: 'home.overview',
      priority: 500,
      openAction: () async {
        Get.to(() => VcoreExamScheduleView(initialDate: DateTime.now()));
    ...
    _homeWidget(
      ...
      keywords: ['thông báo mới', 'chưa đọc', 'notification'],
      fallbackId: 'home.overview',
      priority: 500,
      openAction: () async {
        Get.to(() => const VcoreNotifyViewV3());
    ...
    _homeWidget(
      ...
      icon: Icons.calendar_month_rounded,
      keywords: ['lời nhắc', 'nhắc lịch', 'calendar', 'reminder'],
      fallbackId: 'home.overview',
      priority: 480,
    ),
  ];
  ...
  static final List<AppGuideItem> _homeScheduleItems = [
    _homeWidget(
      ...
      keywords: ['tab', 'lịch học', 'lịch thi', 'chuyển tab'],
    ...
    _homeWidget(
      ...
      keywords: ['thẻ lịch', 'card lịch', 'lịch học', 'lịch thi'],
      fallbackId: 'home.schedule',
      priority: 510,
    ),
    _homeWidget(
      ...
      description:
          'Thẻ hiển thị lớp học hôm nay, tiết học, phòng học và giảng viên.',
      icon: Icons.menu_book_rounded,
      keywords: ['lịch học hôm nay', 'môn học', 'phòng học', 'giảng viên'],
      fallbackId: 'home.schedule',
    ...
    _homeWidget(
      ...
      keywords: ['lịch học sắp tới', 'timeline', 'buổi học'],
      fallbackId: 'home.schedule',
      beforeHighlightActionId: 'home.show_study_tab',
      priority: 490,
    ),
    _homeWidget(
      ...
      description:
          'Chuyển sang tab Lịch thi và xem ca thi gần nhất trong ngày.',
    ...
    _homeWidget(
      ...
      keywords: ['lịch thi sắp tới', 'timeline thi', 'môn thi', 'phòng thi'],
      fallbackId: 'home.schedule',
      beforeHighlightActionId: 'home.show_exam_tab',
      priority: 490,
    ),
  ...
  static final List<AppGuideItem> _homeQuickAccessItems = [
    _homeWidget(
      ...
      description:
          'Tùy chỉnh các chức năng thường dùng trong khu vực truy cập nhanh.',
      icon: Icons.push_pin_rounded,
      keywords: ['ghim', 'pin', 'tùy chỉnh', 'truy cập nhanh'],
    ...
    _homeWidget(
      ...
      icon: Icons.apps_rounded,
      keywords: ['danh sách chức năng', 'truy cập nhanh', 'ghim'],
      fallbackId: 'home.quick_access',
      priority: 510,
    ),
  ];
  ...
  static final List<AppGuideItem> _homeNoticeItems = [
    _homeWidget(
      ...
      icon: Icons.campaign_rounded,
      keywords: ['thông báo quan trọng', 'xem tất cả', 'tin đào tạo'],
    ...
    _homeWidget(
      ...
      description:
          'Các thông báo đào tạo mới nhất được hiển thị trên trang chủ.',
      icon: Icons.list_alt_rounded,
      keywords: ['danh sách thông báo', 'thông báo đào tạo', 'tin đào tạo'],
      fallbackId: 'home.notice',
      priority: 490,
    ),
  ];
  ...
  static final List<AppGuideItem> _homeNewsItems = [
    _homeWidget(
      ...
      icon: Icons.newspaper_rounded,
      keywords: ['tin tức nổi bật', 'xem tất cả', 'tin trường', 'tin vnu'],
    ...
    _homeWidget(
      ...
      icon: Icons.tab_rounded,
      keywords: ['tin trường', 'tin vnu', 'tab tin tức'],
      fallbackId: 'home.news',
      priority: 500,
    ),
    _homeWidget(
      ...
      icon: Icons.view_carousel_rounded,
      keywords: ['carousel', 'tin tức', 'tin nổi bật', 'bài viết'],
      fallbackId: 'home.news',
      priority: 490,
    ),
  ];
  ...
  static final List<AppGuideItem> _homeFunctionItems = [
    _homeFunction(
      ...
      icon: Icons.calendar_month_rounded,
      keywords: ['lịch học', 'lịch thi', 'thời khóa biểu'],
      openAction: () async {
    ...
    _homeFunction(
      ...
      keywords: ['điểm', 'bảng điểm', 'gpa', 'kết quả học tập'],
      openAction: () async {
    ...
    _homeFunction(
      ...
      keywords: ['đăng ký môn', 'đăng ký học phần', 'học phần'],
    ),
    _homeFunction(
      ...
      keywords: ['việc làm', 'tuyển dụng', 'nghề nghiệp'],
      openAction: () async {
    ...
    _homeFunction(
      ...
      keywords: ['học phí', 'tài chính', 'khoản nộp'],
    ),
    _homeFunction(
      ...
      keywords: ['tài liệu', 'file', 'học tập'],
    ),
    _homeFunction(
    ...
    _homeFunction(
      ...
      keywords: ['học bổng', 'scholarship', 'hồ sơ học bổng'],
      openAction: () async {
    ...
    _homeFunction(
      ...
      keywords: ['nội trú', 'ký túc xá', 'dormitory'],
      openAction: () async {
        Get.to(() => const DRMyRegistrationScreen());
      },
    ),
    _homeFunction(
      id: 'home.function.profile_temp_address',
      title: 'Cập nhật tạm trú',
      description:
          'Mở trang Thông tin cá nhân và cuộn thẳng tới Địa chỉ tạm trú.',
    ...
    _homeFunction(
      ...
      keywords: ['phòng trọ', 'nhà trọ', 'motel'],
      openAction: () async {
        openMotelWebView();
      },
    ),
    _homeFunction(
      ...
      keywords: ['thủ tục', 'một cửa', 'hành chính'],
      openAction: () async {
    ...
    _homeFunction(
      ...
      keywords: ['thư viện', 'library', 'sách'],
    ),
    _homeFunction(
      ...
      keywords: ['bản đồ', 'map', 'đường đi', 'vị trí'],
      openAction: () async {
    ...
    _homeFunction(
      ...
      keywords: ['hỏi đáp', 'câu hỏi', 'trao đổi'],
      openAction: () async {
    ...
    _homeFunction(
      ...
      icon: Icons.menu_book_rounded,
      keywords: ['cẩm nang', 'hướng dẫn', 'sinh viên'],
      openAction: () async {
